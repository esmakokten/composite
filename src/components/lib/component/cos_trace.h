...
#define COS_TRACE_NEVENTS (1 << 19) //Must be a power of 2
...
void cos_trace_empty_buffer(void);

/* Attaches the current (cycle, cpuid, thdid, compid) */
#define COS_TRACE(format, a, b, c) cos_trace(format, ps_tsc(), cos_coreid(), cos_thdid(), cos_compid(), a, b, c); 
